...
/**
 * dbweekappointments class
 * @author Erik Scovin
 */
public class DBWeekAppointments {
    ...
    public static ObservableList<Appointments> getAppointments() {
        ...
        try {
            String sql = "SELECT * from appointments WHERE YEARWEEK(NOW(), 0) = YEARWEEK(Start, 0) AND YEAR(now())=YEAR(Start);";
